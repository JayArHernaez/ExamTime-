           ...
           <div class="panel-body">
            ...
            Here are your achievements so far. Create more! :)
              ...
              <table class="table table-hover table-bordered" id="student-table-achiv">
                <thead>
                  <tr>
                    <td style="text-align:center">Average of All Exams</td>
                  </tr>
                </thead>
                <tbody>
                  <tr>
