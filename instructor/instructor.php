      ...
      <div class="container" >
        <div id="list-group ">
          <ul class="nav nav-pills nav-stacked">
            ...
            <li class="active"><a class="nav-stacked" href="instructor.php"><i class="fa fa-dashboard fa-fw "></i>  Dashboard</a></li>
      ...
      <div class="container_user">
          ...
          <div class="panel panel-primary">
            ...
            <div class="panel-body">
              Cheers! It seems like your students are getting better on their exam results! 
            </div>
          </div>
